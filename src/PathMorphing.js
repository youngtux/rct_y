...
const dove =
    "M20 5C19 4 17 4 15 6C13 8 12 11 12 11C12 11 10 9 7 9C4 9 3 11 3 13C3 15 5 18 10 18C14 18 16 16 18 13C20 10 21 7 21 6C21 5.5 20.5 5.5 20 5Z"
const star =
...
const paths = [lightning, note, plane, heart, hand, star, dove]
const colors = [
    "#fff312",
    "#ff0088",
    "#dd00ee",
